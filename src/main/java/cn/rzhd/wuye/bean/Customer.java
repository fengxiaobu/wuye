...
public class Customer implements Serializable {
	...
	public String toString() {
		return "Customer [pk_corp=" + pk_corp + ", pk_customerid=" + pk_customerid + ", fccategory=" + fccategory
				+ ", vccode=" + vccode + ", vcname=" + vcname + ", vpcnamespell=" + vpcnamespell + ", vpreferredtel="
				+ vpreferredtel + ", vccardnum=" + vccardnum + ", vcaddress=" + vcaddress + ", ccpostalcode="
				+ ccpostalcode + ", dregdate=" + dregdate + ", vregplace=" + vregplace + ", vmemcardno=" + vmemcardno
				+ ", vpcemail=" + vpcemail + ", nproperty=" + nproperty + ", LOGO=" + LOGO + ", companyType="
				+ companyType + ", password=" + password + ", bindingPhone=" + bindingPhone + ", houseInfos="
				+ houseInfos + ", currentFlow=" + currentFlow + ", currentHouseId=" + currentHouseId
				+ ", alreadyFinish=" + alreadyFinish + ", updateData=" + updateData + "]";
	}
}
