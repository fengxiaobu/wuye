...
public class DataDictionaryTypeController {
    ...
    /**
     * 获取数据字典
     * @param typeDifferentiateName
     * @return
     */
    @RequestMapping(value = "/findTypeDifferentiateName", method = RequestMethod.GET)
    public TypeDifferentiate findTypeDifferentiateNameIsRepeat(String typeDifferentiateName) {

        TypeDifferentiate typeDifferentiateNameIsRepeat = dataDictionaryService.findTypeDifferentiateNameIsRepeat(typeDifferentiateName);
        return typeDifferentiateNameIsRepeat;
    }
