          ...
          <table class="table table-bordered table-form">
            <tbody>
              ...
              <tr v-show="userCheckedApplyType==0">
                <th>续租开始日期</th>
                <td><input class="editdate" id="retreaTimeClick" type="text" v-model="retreaTime" v-datetimepicker="retreaTimeClick"></td>
              </tr>
              <tr v-show="userCheckedApplyType==0">
                <th>续租截止日期</th>
                <td><input class="editdate" id="retreaEndTimeClick" type="text" v-model="retreaEndTime" v-datetimepicker="retreaEndTimeClick"></td>
              </tr>
              <tr v-show="userCheckedApplyType==1">
                <th>退租日期</th>
                <td><input class="editdate" id="retreatLeaseTimeClick" type="text" v-model="retreatLeaseTime" v-datetimepicker="retreatLeaseTimeClick"></td>
              </tr>
              <tr v-show="userCheckedApplyType==1">
                <th>退租类型</th>
                <td>正常退租</td>
              ...
              <tr>
                <th></th>
                <td><button class="btn" @click="submit">提交申请</button></td>
              </tr>
            </tbody>
          </table>
</form>
