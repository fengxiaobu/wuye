                ...
                <div class="col-xs-6dd">
                    <form action="" method="post">
                        <span style="margin-right: 50px"><input style="height: 35px;width: 220px;" type="text"
                                                                name="projectName"
                                                                placeholder="&nbsp;&nbsp;项目名称,资料包名称,用户名"></span>
            ...
            <table class="table table-bordered tudiqianyue-table">
                ...
                <c:forEach items="${houseInfoDetailsList}" var="houseInfoDetailsList" varStatus="status">
                    <tr class="tudiqianyue-tdtr">
                        ...
                        <td>${houseInfoDetailsList.vhcode}</td>
                        <td>${houseInfoDetailsList.nsellarea}</td>
                        <td>${houseInfoDetailsList.signVO.nprice}</td>
                        <td>${houseInfoDetailsList.signVO.nythisdiscountmny}</td>
