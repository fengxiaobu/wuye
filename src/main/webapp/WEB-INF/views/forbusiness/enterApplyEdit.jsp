        ...
        <form class="form-horizontal" action="" method="post" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 radio">
                    <label>
                        <input type="radio" name="optionsRadios" id="optionsRadios1" <c:if test="${enterApply.auditStatus eq 0}">checked="checked"</c:if>
                               value="option1"/>未审核
                    </label>
                    <label>
                        <input type="radio" name="optionsRadios" id="optionsRadios2" <c:if test="${enterApply.auditStatus eq 1}">checked="checked"</c:if>
                               value="option2"/>已通过
                    </label>
                    <label>
                        <input type="radio" name="optionsRadios" id="optionsRadios3" <c:if test="${enterApply.auditStatus eq 2}">checked="checked"</c:if>
                               value="option2"/>未通过
                    </label>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="col-sm-2 control-label">
                            <textarea name="" cols="30" rows="10">${enterApply.notes}</textarea>
                        </label>
                    </div>
                </div>
            <div class="form-group">
