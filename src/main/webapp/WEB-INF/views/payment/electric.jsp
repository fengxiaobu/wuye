...
-->
                ...
                <c:forEach items="${electricRecords}" var="item">
                    <tr class="tudiqianyue-tdtr">
                        ...
                        <td></button>&nbsp;&nbsp;&nbsp;&nbsp;<a
                                class="btn btn-info"
                                href="${pageContext.request.contextPath}/utilitiesRecords/electricDetails?id=${item.detailsId}"
                                role="button">详情</a></td>
                    </tr>
                </c:forEach>
                </tbody>
