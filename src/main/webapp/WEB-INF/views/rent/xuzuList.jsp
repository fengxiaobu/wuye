        ...
        <div class="panel-heading">
            ...
            <div class="col-xs-8 panel-oprerate">
                <div class="col-xs-6dd">
                    <form action="${basePath}/reletApply/search" method="post">
                        <%--<div class="col-xs-8 panel-oprerate">
                        ...
                        <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div id="form_datetime" class="input-group date form_datetime col-sm-3" data-date=""
                                    ...
                                    <input id="showdate1" class="form-control" size="16" type="text"
                                           value="${startDate}"
                                           readonly="readonly">
                                ...
                                <input type="text"
                                       class="form-control" name="clientName" placeholder="项目名称、用户名"
                                       value="${clientName}"/>
