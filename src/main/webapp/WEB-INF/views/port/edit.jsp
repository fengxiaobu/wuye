        ...
        <form method="post" id="formproject" action="return false;">
            <div class="addmes-cnt">
                ...
                <div class="mestr">
                    ...
                    <div class="lasttd">
                        <input type="radio" class="request_way" value="POST" name="type" ${port.type=='POST'?'checked':''}>POST
                        <input type="radio" class="request_way" value="GET" name="type" ${port.type=='GET'?'checked':''}>GET
                    </div>
                </div>
                <div class="mestr">
 ...
 $("#btn_submit").click(function(){
		layer.confirm('请确认数据检查无误并提交?', {icon: 3, title:'提示'}, function(index){
			...
			$.ajax({
			   ...
			   statusCode :{
				   201 : function(){
						layer.alert('编辑成功!', {icon: 6,skin: 'layer-ext-moon'},function(){location.href = "/dist/port/index"})
				   },
				   500 : function(){
