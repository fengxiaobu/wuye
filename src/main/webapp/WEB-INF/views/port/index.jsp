    ...
    <div class="search">
			<form id="formquery" onsubmit="return false;">
				<div>
					...
					<label>更新时间：</label>
		            <input id="d5221" class="Wdate" type="text" readonly="readonly"  onFocus="var d5222=$dp.$('d5222');WdatePicker({onpicked:function(){d5222.focus();},maxDate:'#F{$dp.$D(\'d5222\')}'})"/>
					至
					<input id="d5222" class="Wdate" type="text" readonly="readonly"  onFocus="WdatePicker({minDate:'#F{$dp.$D(\'d5221\')}'})"/>
