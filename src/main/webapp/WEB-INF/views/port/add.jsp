        ...
        <form method="post" id='formproject' onsubmit="return false;" >
            <div class="addmes-cnt">
                ...
                <div class="mestr">
                    ...
                    <div class="lasttd">
                        <input type="radio" class="request_way" value="POST" name="type">POST
                        <input type="radio" class="request_way" value="GET" name="type">GET
                    </div>
                </div>
                <div class="mestr">
                    <div class="firsttd">请求参数</div>
                    <div class="lasttd">
                        <textarea name="param" cols="100" rows="20"></textarea>
                    </div>
                </div>
                <div class="mestr">
