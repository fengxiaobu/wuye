...
<body>
	...
	<p class="index-sectionheader">
		<span>当前位置 : </span> <span>首页 - 系统管理 - 编辑角色</span> 
	</p>
	<div class="addmes">
		<p class="addclick">
			...
			<form method="POST" id='formproject' onsubmit="return false;">
				...
				<%-- <input type="hidden" id="ids" value="${ids }"> --%>
					...
					<div class="mestr">
						...
						<div class="lasttd">
							<input id="code" type="text" name="code" value="${role.code }">
						</div>
					</div>
					<div class="mestr">
						<div class="firsttd">描述:</div>
						<div class="lasttd">
							<textarea name="description" rows="4" cols="33" value="${role.description }"></textarea>
						</div>
					</div>
					<div class="mestr">
