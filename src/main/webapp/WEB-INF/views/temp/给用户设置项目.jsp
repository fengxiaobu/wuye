...
// 								layer.alert('用户绑定项目成功!', {icon: 6,skin: 'layer-ext-moon'},function(){ location.href = "${pageContext.request.contextPath }/rest/user/touserlist" ; })
								layer.alert('用户绑定项目成功!', {icon: 6,skin: 'layer-ext-moon'},function(){ history.go(-1) ; })
							},
							400 : function() {
								layer.alert('提交的参数不合法！', {icon: 5,skin: 'layer-ext-moon'})
							},
							402 : function() {
								layer.alert('登录信息已过期，请重新登录！', {icon: 5,skin: 'layer-ext-moon'},function(){ window.parent.location.href  = "${pageContext.request.contextPath }/login.jsp";})
							},
							500 : function() {
