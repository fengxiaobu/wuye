    ...
    <form method="POST" id='formproject' onsubmit="return false;" class="form-horizontal">
        <div class="panel panel-default">
            ...
            <div class="panel-body project_sign_box">
                <textarea id="contentqq" class="project_sign" rows="9" name="info" cols="150"
                          style="visibility:hidden;">${dictInfo.info }</textarea>
                <!-- <p>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label ">上次更新时间：<fmt:formatDate value="${dictInfo.updateTime }"
    ...
    $("#btn_submit").click(function () {
        ...
        if (count < 2000) {
            $.ajax({
                ...
                statusCode: {
                    201: function () {
                        layer.alert('入住提示信息编辑成功!', {icon: 6, skin: 'layer-ext-moon'}, function () {
                            location.href = "${basePath}/admin/sys/rename/3"
                        })
                    },
                    400: function () {
