            ...
            <form method="post" id='formproject' onsubmit="return false;">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body project_sign_box">
                                <textarea class="project_sign" rows="3" name="occupNotice"
                                          cols="50">${sys.occupNotice}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body project_sign_box">
                                <textarea class="project_sign" rows="3" name="checkIn"
                                          cols="50">${sys.checkIn}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body project_sign_box">
                                <textarea class="project_sign" rows="3" name="payAmountPrompt"
                                          cols="50">${sys.payAmountPrompt}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="panel-heading">
                            ...
                            <div class="panel-body project_sign_box">
                                <textarea class="project_sign" rows="3" name="propertyArreaesTips"
                                          cols="50">${sys.propertyArreaesTips}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text" name="threePartyAgree"
                                   value="${sys.threePartyAgree}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input class="form-control" type="text"
                                   placeholder="<fmt:formatDate value='${sys.updateTime }' pattern="yyyy-MM-dd HH:mm"/>"
                                   readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10 ">
                            <button id="btn_submit" class="btn btn-success from_sub" type="submit"><span
                                    class="glyphicon glyphicon-ok"></span>保存
                            </button>
                            <button class="btn btn-success from_sub" type="submit" id="cancelBtn"
                                    onclick="history.back(-1)"><span class="glyphicon glyphicon-ok"></span>取消
                            </button>
                        </div>
                    </div>
    ...
    $("#btn_submit").click(function () {
        layer.confirm('请确认数据检查无误并提交?', {icon: 3, title: '提示'}, function (index) {
            ...
            $.ajax({
                ...
                statusCode: {
                    201: function () {
                        layer.alert('设置成功!', {icon: 6, skin: 'layer-ext-moon'}, function () {
                            location.href = "${basePath}/admin/sys/set"
                        })
                    },
                    500: function () {
