        ...
        <div class="panel-heading">
            ...
            <div class="col-xs-8 panel-oprerate">
                <div class="col-xs-6dd">
                    <a href="${pageContext.request.contextPath}/typeRefinement/getTypeDataEdit?typeDifferentiateId=${typeDifferentiateId}"
                    ...
                    <c:forEach items="${typeRefinements}" var="typeRefinements" varStatus="status">
                        <tr class="tudiqianyue-tdtr">
                            ...
                            <td><a class="btn btn-info"
                                   href="${pageContext.request.contextPath}/typeRefinement/getTypeDataEdit?typeRefinementId=${typeRefinements.typeRefinementId}&typeDifferentiateId=${typeRefinements.typeDifferentiateId}"
                                   role="button">编辑</a>
                                <a class="btn btn-info" onclick="del('${typeRefinements.typeRefinementId}',this)"
                                   role="button">删除</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
