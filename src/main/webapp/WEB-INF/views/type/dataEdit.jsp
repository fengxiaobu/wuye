...
<div class="col-xs-12">
    <div class="panel panel-default">
        <div class="panel-body">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/typeRefinement/addOrUpdate"
                  method="post">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control renwushixiang" name="typeRefinementName"
                                   value="${typeRefinement.typeRefinementName }">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="radio" name="status" value="0"
                                   <c:if test="${typeRefinement.status eq 0}">checked="checked"</c:if>/>启用
                            <input type="radio" name="status" value="1"
                                   <c:if test="${typeRefinement.status eq 1}">checked="checked"</c:if>/>禁用
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">更新日期：</label>
                        <div class="col-sm-3">
                            <fmt:formatDate value="${typeRefinement.updateTime}" type="both"
